...
public class StringUtils {
	...
	public static String hideLastChineseChar(String str,int len){
		if(str==null) return null;
		char[] chars=str.toCharArray();
		if(str.length()<=len){
	...
	public static String getFullTimeStr(){
		String s=DateUtils.dateStr9(Calendar.getInstance().getTime());
		return s;
	}
	...
	public static String getEmailLoginUrl(String email){
    	...
    	url = url.toLowerCase();
    	if (url .equals("163.com") ) {
            return "mail.163.com";
        } else if (url .equals("vip.163.com")) {
            return "vip.163.com";
        } else if (url.equals("126.com") ) {
            return "mail.126.com";
        } else if (url.equals( "qq.com") || url .equals("vip.qq.com")  || url .equals("foxmail.com") ) {
            return "mail.qq.com";
        } else if (url .equals("gmail.com") ) {
            return "mail.google.com";
        } else if (url .equals("sohu.com") ) {
            return "mail.sohu.com";
        } else if (url .equals("tom.com") ) {
            return "mail.tom.com";
        } else if (url .equals("vip.sina.com") ) {
            return "vip.sina.com";
        } else if (url .equals("sina.com.cn")  || url .equals("sina.com") ) {
            return "mail.sina.com.cn";
        } else if (url .equals("tom.com") ) {
            return "mail.tom.com";
        } else if (url .equals("yahoo.com.cn")  || url .equals("yahoo.cn") ) {
            return "mail.yahoo.com";
        } else if (url .equals("yeah.net") ) {
            return "www.yeah.net";
        } else if (url .equals("21cn.com") ) {
            return "mail.21cn.com";
        } else if (url .equals("hotmail.com") ) {
            return "www.hotmail.com";
        } else if (url .equals("sogou.com") ) {
            return "mail.sogou.com";
        } else if (url .equals("188.com") ) {
            return "www.188.com";
        } else if (url .equals("139.com") ) {
            return "mail.10086.cn";
        } else if (url .equals("189.cn") ) {
            return "webmail15.189.cn/webmail";
        } else if (url .equals("wo.com.cn") ) {
